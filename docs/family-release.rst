...
0.8.2 Scope Decision
--------------------

Mixle Core 0.8.2 is deliberately a **standalone core release**, not a
coordinated family release. ``mixle-knowledge``, ``mixle-mlops``,
``mixle-pde``, ``mixle-discrete``, ``mixle-agent``, ``mixle-demos``,
``mixle-notebooks``, and ``mixle-ios`` are all excluded from the 0.8.2
...
No item in this section is claimed or required by the standalone Core 0.8.2
release.
