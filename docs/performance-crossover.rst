...
The 0.8.2 release does not publish a numerical crossover table. Historical
...
No GPU or distributed-backend performance number is claimed for 0.8.2 without a
