...
Version 0.8.1 is a published release; its claims are the ones its dated evidence supports. Version 0.8.2 is prepared as its patch release and remains unreleased until all applicable gates have accepted evidence. Version 0.8.0 was prepared under the same evidence but never published (D-0212).
