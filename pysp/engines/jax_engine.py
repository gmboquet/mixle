...
* **float64 is opt-in.** JAX defaults to float32; pysp accumulates in float64, so this module enables
...
try:
    ...
    jax.config.update("jax_enable_x64", True)  # pysp accumulates in float64; JAX is float32 by default
