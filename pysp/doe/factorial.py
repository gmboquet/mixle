...
These complement the space-filling generators in :mod:`pysp.doe.designs` with the structured "named"
...
coded matrix instead (the natural input to the analysis routines in :mod:`pysp.doe.analysis`).
"""
...
from pysp.doe.designs import Bounds, _as_bounds
