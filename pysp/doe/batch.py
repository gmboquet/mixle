...
The kriging-believer batch in :mod:`pysp.doe.bayesopt` fantasizes the posterior *mean* at each pick --
...
from pysp.doe.bayesopt import _fit_surrogate, _validate_xy
