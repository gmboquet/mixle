...
def test_a1_power_law_hawkes_encoder_is_abc_and_equal():
    ...
    from pysp.stats.leaf.power_law_hawkes import PowerLawHawkesDataEncoder
...
def test_a1_power_law_hawkes_accumulator_is_abc():
    ...
    from pysp.stats.leaf.power_law_hawkes import (
...
def test_a4_bernoulli_set_estimate_preserves_keys():
    from pysp.stats.sets.bernoulli_set import BernoulliSetEstimator
...
def test_d1_all_engines_provide_required_ops():
    ...
    try:
        ...
        pass
    try:
        from pysp.engines.torch_engine import TorchEngine
