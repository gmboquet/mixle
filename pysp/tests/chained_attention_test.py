"""Chained (multi-hop) attention via forward-backward (pysp.stats.latent.chained_attention)."""
...
class ForwardBackwardTest(unittest.TestCase):
    def test_matches_brute_force_enumeration(self):
        ...
        from pysp.stats.latent.chained_attention import _forward_backward, _gate, _softmax
