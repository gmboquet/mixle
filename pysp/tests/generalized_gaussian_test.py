...
import pysp
from pysp.capability import HasCDF, HasEntropy, HasMoments
from pysp.stats import GeneralizedGaussianDistribution as GG
...
class GeneralizedGaussianTest(unittest.TestCase):
    ...
    def test_capabilities(self):
        ...
        for cap in (HasCDF, HasMoments, HasEntropy):
            self.assertTrue(pysp.supports(d, cap))
