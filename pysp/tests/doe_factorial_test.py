"""Classical factorial / screening / response-surface designs (pysp.doe.factorial)."""

import unittest

import numpy as np

from pysp.doe import box_behnken, central_composite, fractional_factorial, plackett_burman
