"""Rigorous batch (multi-point) Bayesian optimization (pysp.doe.batch)."""
...
from pysp.doe.batch import monte_carlo_qei
...
class BatchProposalTest(unittest.TestCase):
    ...
    def test_qei_batch_is_diverse(self):
        from pysp.doe import propose_qei_batch
    ...
    def test_local_penalization_is_diverse(self):
        from pysp.doe import propose_local_penalization
