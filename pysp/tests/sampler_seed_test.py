...
def _stats_public_distribution_catalog():
    ...
    return {
        ...
        'HeterogeneousMixtureDistribution': stats.HeterogeneousMixtureDistribution(
            [stats.GaussianDistribution(0.0, 1.0), stats.CategoricalDistribution({'a': 0.8, 'b': 0.2})],
            [0.5, 0.5]),
        ...
        'IntegerStepBernoulliEditDistribution': stats.IntegerStepBernoulliEditDistribution(
            log_edit, init_dist=int_set),
        ...
        'IntegerUniformSpikeDistribution': stats.IntegerUniformSpikeDistribution(
            k=2, num_vals=5, p=0.5, min_val=0),
        ...
        'SegmentalHiddenMarkovDistribution': stats.SegmentalHiddenMarkovDistribution(
            ...
            [[0.7, 0.3], [0.2, 0.8]],
            len_dist=stats.IntegerCategoricalDistribution(2, [1.0])),
        'BernoulliSetDistribution': stats.BernoulliSetDistribution(
            {'a': 0.7, 'b': 0.2, 'c': 0.9}, min_prob=0.0),
...
def _bstats_public_distribution_catalog():
    ...
    return {
        ...
        'IntegerCategoricalDistribution': bstats.IntegerCategoricalDistribution(
            [0.2, 0.3, 0.5], min_index=0),
