"""pysp.stats.sample: one entry point dispatching across every samplable pysp object (Phase C)."""
...
from pysp.stats import BernoulliDistribution, GaussianDistribution, MixtureDistribution, sample
from pysp.stats.bayes.conjugate import conjugate_posterior
