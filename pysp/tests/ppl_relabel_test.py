...
from pysp.ppl import Mix, Normal
from pysp.ppl.inference import _exchangeable_layout, _relabel_chain
...
class RelabelUnitTest(unittest.TestCase):
    ...
    def test_layout_none_for_non_mixture(self):
        slots, _ = __import__("pysp.ppl.inference", fromlist=["_collect_composite"])._collect_composite(
