...
FILE_MARKERS: dict[str, MarkerTuple] = {
    ...
    "black_scholes_test.py": ("ppl", "pde", "integration", "slow"),
    "conformal_test.py": ("ppl", "integration", "slow"),
    "flow_test.py": ("ppl", "pde", "integration", "slow"),
    ...
    "gas_dynamics_test.py": ("ppl", "pde", "integration", "slow"),
    ...
    "implicit_3d_test.py": ("ppl", "pde", "integration", "slow"),
