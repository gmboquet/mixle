"""Native numpy random forest (CART trees + bootstrap bagging) used by pysp.models.random_forest.

Pure numpy so pysparkplug carries no scikit-learn dependency. Supports weighted observations (needed for EM
