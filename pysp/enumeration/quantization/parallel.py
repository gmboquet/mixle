...
(:mod:`pysp.utils.parallel.planner` ``Resources`` and ``_split_range``):
...
from pysp.utils.parallel.planner import _split_range
...
class ConvolutionExecutor:
    ...
    def convolve(self, a, b, max_fine_bucket: int | None = None):
        from pysp.enumeration.quantization.core import CountHistogram
