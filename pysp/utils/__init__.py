...
_LAZY_EXPORTS = {
    "analyze_structure": ("pysp.utils.automatic", "analyze_structure"),
    "htsne": ("pysp.utils.hvis", "htsne"),
}
...
def __getattr__(name: str):
    ...
    if name in _SUBMODULES:
        return importlib.import_module("pysp.utils." + name)
    raise AttributeError("module 'pysp.utils' has no attribute %r" % name)
