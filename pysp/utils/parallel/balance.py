"""Automatic compute / memory / load-balancing planner for EM estimation of *any* pysparkplug model.
...
from pysp.stats.compute.decomposition import DecompAxis
from pysp.utils.parallel.model_decomposition import (
    ModelCut,
    best_parallel_axis,
    compute_cost,
)
