...
The pysp distribution enumerators (``dist.enumerator()``) need a pysp distribution. These utilities instead
...
pysp distribution. Nothing here imports a deep-learning framework; the caller's callable bridges to their model.
