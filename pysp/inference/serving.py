...
A :class:`ModelService` wraps a fitted model (loaded directly or from a :class:`ModelRegistry` alias) and
...
class ModelService:
    ...
    def check_drift(self, records: Any) -> Any:
        ...
        if self.reference is None:
            raise ValueError("ModelService has no reference sample; pass reference= to enable drift checks")
        from pysp.inference.drift import detect_drift
