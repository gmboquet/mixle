...
# pysp.stats.bayes.dirichlet.DirichletDistribution and ``row_priors`` is a length-S list of the same.
...
class _MarkovChainGradientFitState:
    ...
    def log_prior(self, priors, prior_strength: float, torch, engine, initial_leaves_by_id, prior_child):
        from pysp.stats.compute.gradient import dirichlet_alpha_tensor, markov_chain_priors, prior_family, prior_zero
