...
VonMisesEstimator, and the VonMisesDataEncoder classes for use with pysparkplug.
...
mu). This is the one-dimensional companion to :class:`~pysp.stats.multivariate.vmf` (the von
