...
pysp.stats.latent.hidden_markov), while the M-step performs coordinate ascent on the expected
...
class QuantizedHiddenMarkovModelDistribution(HiddenMarkovModelDistribution):
    ...
    def to_fisher(self, **kwargs):
        ...
        if hasattr(self, "topics") and hasattr(self, "transitions"):
            from pysp.stats.latent.hidden_markov import HiddenMarkovFisherView
