...
This is a variant of pysp.stats.latent.hidden_markov where the initial state probabilities are NOT shared across
...
from pysp.stats.latent._hmm_numba_kernels import numba_seq_log_density
...
class IndPiHiddenMarkovEstimatorAccumulator(SequenceEncodableStatisticAccumulator):
    ...
    def seq_update_engine(self, x, weights, estimate, engine):
        ...
        """
        from pysp.stats.latent.hidden_markov import hmm_engine_forward_backward
