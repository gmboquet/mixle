"""Text connectors -- CSV / JSON / JSONL (NDJSON) into a :class:`~mixle.data.core.DataSource`.

Pure standard library: usable in the base install with no extra. A :class:`~mixle.data.schema.Schema`
