...
Optional: requires ``pymongo`` (``pip install mixle[mongo]``). The ``_id`` field is dropped; supply
a :class:`~mixle.data.schema.Schema` to coerce the loosely-typed BSON documents.
"""
