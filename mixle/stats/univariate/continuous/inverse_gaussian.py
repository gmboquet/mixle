...
class InverseGaussianDistribution(SequenceEncodableProbabilityDistribution):
    ...
    def __setattr__(self, name: str, value: Any) -> None:
        """Keep the cached ``log_lam`` tied to the parameter ``lam`` it derives from.
        ...
        if name not in ("lam",):
            return
        try:
            object.__setattr__(self, "log_lam", math.log(self.lam))
            ...
            object.__setattr__(self, "log_lam", float("nan"))
