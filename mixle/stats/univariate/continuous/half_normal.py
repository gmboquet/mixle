...
class HalfNormalDistribution(SequenceEncodableProbabilityDistribution):
    ...
    def __setattr__(self, name: str, value: Any) -> None:
        """Keep ``log_sigma`` tied to the parameter(s) ``sigma`` they derive from.
        ...
        if name not in ("sigma",):
            return
        try:
            object.__setattr__(self, "log_sigma", float(math.log(self.sigma)))
            ...
            object.__setattr__(self, "log_sigma", float("nan"))
