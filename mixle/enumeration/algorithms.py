...
* generic stream primitives        -> :mod:`mixle.enumeration.streams`
* best-first / product search      -> :mod:`mixle.enumeration.best_first`
* the quantized seek / unrank index -> :mod:`mixle.enumeration.quantization.seek`
...
from mixle.enumeration.streams import (
    BufferedStream,
    freeze,
    merge_enumerators,
