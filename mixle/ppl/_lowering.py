...
Maps each user-facing distribution name to its underlying mixle ``*Distribution`` / ``*Estimator`` and
the arg / seed / read quartet that lowers a :class:`~mixle.ppl.core.RandomVariable` into a fittable mixle
model. This module is imported for its **side effects**: the ``register_family`` / ``register_composite``
calls run at import, so ``mixle.ppl`` imports it before any dialect constructor (``mixle.ppl.distributions``)
...
from mixle.stats.latent.hidden_markov import HiddenMarkovEstimator, HiddenMarkovModelDistribution
...
from mixle.stats.multivariate.diagonal_gaussian import DiagonalGaussianDistribution, DiagonalGaussianEstimator
from mixle.stats.multivariate.multivariate_gaussian import (
    MultivariateGaussianDistribution,
    MultivariateGaussianEstimator,
)
from mixle.stats.univariate.continuous.beta import BetaDistribution, BetaEstimator
...
from mixle.stats.univariate.continuous.gumbel import GumbelDistribution, GumbelEstimator
from mixle.stats.univariate.continuous.half_normal import HalfNormalDistribution, HalfNormalEstimator
from mixle.stats.univariate.continuous.inverse_gamma import InverseGammaDistribution, InverseGammaEstimator
from mixle.stats.univariate.continuous.inverse_gaussian import InverseGaussianDistribution, InverseGaussianEstimator
from mixle.stats.univariate.continuous.laplace import LaplaceDistribution, LaplaceEstimator
from mixle.stats.univariate.continuous.log_gaussian import LogGaussianDistribution, LogGaussianEstimator
from mixle.stats.univariate.continuous.logistic import LogisticDistribution, LogisticEstimator
from mixle.stats.univariate.continuous.nakagami import NakagamiDistribution, NakagamiEstimator
from mixle.stats.univariate.continuous.pareto import ParetoDistribution, ParetoEstimator
from mixle.stats.univariate.continuous.rayleigh import RayleighDistribution, RayleighEstimator
from mixle.stats.univariate.continuous.rician import RicianDistribution, RicianEstimator
from mixle.stats.univariate.continuous.skew_normal import SkewNormalDistribution, SkewNormalEstimator
from mixle.stats.univariate.continuous.student_t import StudentTDistribution, StudentTEstimator
from mixle.stats.univariate.continuous.tweedie import TweedieDistribution, TweedieEstimator
from mixle.stats.univariate.continuous.uniform import UniformDistribution, UniformEstimator
from mixle.stats.univariate.continuous.weibull import WeibullDistribution, WeibullEstimator
...
from mixle.stats.univariate.discrete.geometric import GeometricDistribution, GeometricEstimator
from mixle.stats.univariate.discrete.integer_categorical import (
    IntegerCategoricalDistribution,
    IntegerCategoricalEstimator,
)
from mixle.stats.univariate.discrete.logseries import LogSeriesDistribution, LogSeriesEstimator
from mixle.stats.univariate.discrete.negative_binomial import NegativeBinomialDistribution, NegativeBinomialEstimator
...
def _mix_seed(args, data, rng, seed_child):
    ...
    if any(ch is None for ch in children):
        return None  # a component can't be seeded -> fall back to mixle default init
...
# self-registers from the mixle-pde plugin's modules when that package is imported -- so this
# lowering hub (and mixle generally) no longer references the PDE stack.
from mixle.ppl import statespace  # noqa: F401, E402  (import-time StateSpace registration)
