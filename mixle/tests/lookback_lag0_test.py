...
Covers mixle.stats.latent.lookback_hidden_markov_model (the typed lookback HMM). With lag=0 there is no initial segment:
...
mixle.stats.latent.hidden_markov.HiddenMarkovModelDistribution, that sampled sequence lengths match the
