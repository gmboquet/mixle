...
# mixle.task.quantize on this worktree's base no longer exposes standalone symmetric_quantize/
# dequantize_symmetric -- see mixle.models.unified_quantizer's module docstring vendoring note.
# quantize_dequantize_array(w, *, bits, clip_percentile) is the current single function; the
# dequantize half is the one-line multiply used inline below.
