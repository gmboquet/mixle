...
from mixle.utils.automatic import DictRecordDistribution, DictRecordEstimator, analyze_structure, get_estimator
...
class AutomaticScientificProfilingTestCase(unittest.TestCase):
    ...
    def test_bayesian_gaussian_provider_carries_conjugate_default_prior(self):
        ...
        # The Bayesian path now builds a mixle.stats estimator carrying the
