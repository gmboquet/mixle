...
from mixle.inference.fisher import FisherView, SufficientStatisticVectorizer
...
from mixle.utils.special import digamma, trigamma
...
class FisherViewTestCase(unittest.TestCase):
    ...
    def test_bayes_combinators_have_encoded_parity(self):
        from mixle.stats.bayes.dirichlet import DirichletDistribution as BayesianDirichletDistribution
        from mixle.stats.combinator.optional import OptionalDistribution as BayesianOptionalDistribution
        from mixle.stats.combinator.sequence import SequenceDistribution as BayesianSequenceDistribution
        ...
        from mixle.stats.univariate.continuous.exponential import (
            ExponentialDistribution as BayesianExponentialDistribution,
        )
        from mixle.stats.univariate.continuous.gamma import GammaDistribution as BayesianGammaDistribution
        from mixle.stats.univariate.continuous.gaussian import GaussianDistribution as BayesianGaussianDistribution
        from mixle.stats.univariate.continuous.log_gaussian import (
            LogGaussianDistribution as BayesianLogGaussianDistribution,
        )
        from mixle.stats.univariate.discrete.binomial import BinomialDistribution as BayesianBinomialDistribution
        from mixle.stats.univariate.discrete.categorical import (
            CategoricalDistribution as BayesianCategoricalDistribution,
        )
