...
class AnchorHarnessTest(unittest.TestCase):
    ...
    def test_premise_check_is_real_not_assumed(self):
        """CARD F2-a's contract: a hop's premise receipt must be a computed verdict, never hardcoded
        ...
        with self.assertRaisesRegex(ValueError, "lack an affirmative premise receipt"):
