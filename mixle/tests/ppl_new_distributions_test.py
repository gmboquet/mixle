...
These expose mixle leaf distributions (HalfNormal, InverseGamma, InverseGaussian, Gumbel, SkewNormal,
Skellam, LogSeries) as mixle.ppl random variables -- the scale/variance priors and skewed/heavy-tailed
likelihoods a Bayesian modeller reaches for. Each is checked by sampling from the known mixle law and
...
from mixle.stats.univariate.continuous.generalized_extreme_value import GeneralizedExtremeValueDistribution
from mixle.stats.univariate.continuous.generalized_gaussian import GeneralizedGaussianDistribution
...
from mixle.stats.univariate.continuous.tweedie import TweedieDistribution
