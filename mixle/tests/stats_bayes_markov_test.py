"""Conjugate-Bayesian closed-form and additivity tests for the folded mixle.stats Markov models.
...
The conjugate Dirichlet priors are the mixle.stats DirichletDistribution.
"""

import numpy as np
import pytest

import mixle.stats.latent.hidden_markov as shmm
import mixle.stats.sequences.markov_chain as smc
import mixle.stats.univariate.continuous.gaussian as sgauss
from mixle.stats.bayes.dirichlet import DirichletDistribution as Dir
