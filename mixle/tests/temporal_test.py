...
from mixle.stats.processes.temporal import PeriodicTimeDistribution, SeasonalTimeSeries, cyclic_phase, to_unix_seconds


def _fit_periodic(times, period="day"):
    """Fit a PeriodicTimeDistribution through the mixle estimator contract."""
