"""Tests for mixle.stats symdirichlet, catdirichlet, int_range, bernoulli, and beta.

Migrated from the original wave-2 suite. Each test class preserves the regression
coverage of runtime-confirmed math bugs, asserted now against the folded mixle.stats
implementations:
  ...
  - BetaDistribution is a mixle.stats ProbabilityDistribution.
...
from mixle.stats.univariate.continuous.beta import BetaDistribution, BetaSampler
...
class BetaTestCase(unittest.TestCase):
    def test_uses_stats_base_class(self):
        ...
        # mixle.stats ProbabilityDistribution.
