"""Smoke + correctness tests for the mixle.ppl facade (build slices 1-2)."""

import unittest

import numpy as np

from mixle.ppl import Categorical, Exponential, Gamma, Markov, Mix, Normal, Poisson, Seq, compare, free
...
class PPLCoreTestCase(unittest.TestCase):
    ...
    def test_new_families_recover(self):
        from mixle.ppl import LogNormal, NegativeBinomial, StudentT
    ...
    def test_multivariate_gaussian(self):
        from mixle.ppl import MVN, DiagGaussian
