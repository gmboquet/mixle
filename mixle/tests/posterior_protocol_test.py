"""IC-1 -- the shared `Posterior` protocol is a frozen, runtime-checkable structural type (work-plan E1).

Landed alongside E1's `mixle_pde.latent.PosteriorField3D` conformance work: this is the protocol's own
conformance test (the frozen text of ``notes/exec/contracts.md`` IC-1), independent of any one
implementation.
"""
