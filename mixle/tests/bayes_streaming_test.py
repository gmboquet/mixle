...
from mixle.inference.estimation import BayesianStreamingEstimator, forgetting
...
from mixle.stats.latent.mixture import mixture_prior
...
class BayesianStreamingEstimatorTestCase(unittest.TestCase):
    def assertPriorClose(self, actual, expected):
        ...
        # Structured priors in mixle.stats are (possibly nested) tuples/lists, e.g. the optional
