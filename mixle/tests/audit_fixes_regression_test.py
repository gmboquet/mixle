...
def test_h3_beta_posterior_mode_is_a_over_a_plus_b():
    from mixle.stats.sets.bernoulli_set import _beta_posterior_mode
...
def test_m8_gaussian_conjugate_scatter_is_nonnegative_offset_data():
    from mixle.stats.bayes.conjugate import _build_gaussian
...
def test_m6_survival_deep_tail_is_finite_not_neg_inf():
    from mixle.stats.combinator.survival import SurvivalDistribution
