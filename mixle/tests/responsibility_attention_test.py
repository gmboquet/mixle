"""Responsibility-attention head: EM-able mixture over context positions (mixle.stats.latent)."""
...
class CompositionTest(unittest.TestCase):
    def test_fits_inside_a_mixture(self):
        # the headline claim: a responsibility-attention head composes with other mixle models
