"""Variational-EM attention with tied latent embeddings (mixle.stats.latent)."""
...
from mixle.stats.latent.responsibility_attention import ResponsibilityAttentionEstimator
