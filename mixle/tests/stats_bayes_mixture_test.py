"""Bayesian (conjugate / variational) behavior folded onto the mixle.stats finite mixture.
...
from mixle.inference.estimation import _data_objective_sum, _model_objective, fit, optimize
