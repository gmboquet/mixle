...
from mixle.utils.parallel.balance import auto_balanced_estimator, balance_plan
from mixle.utils.parallel.model_decomposition import compute_cost, cost_children, subtree_work
...
class SpectrumDecisionTest(unittest.TestCase):
    ...
    def test_massive_hmm_single_observation_is_model_parallel(self):
        ...
        self.assertEqual(plan.workers_used, 8)
        self.assertEqual(
            plan.axis, __import__("mixle.stats.compute.decomposition", fromlist=["DecompAxis"]).DecompAxis.STATE
        )
