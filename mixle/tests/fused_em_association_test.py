...
from mixle.stats.latent.indian_buffet_process import IndianBuffetProcessDistribution, IndianBuffetProcessEstimator
...
from mixle.stats.multivariate.integer_multinomial import IntegerMultinomialDistribution, IntegerMultinomialEstimator
